...
pub fn tr(lang: &str, key: &str) -> &'static str {
    ...
    match (l, key) {
        ...
        ("pt-BR", "quit_app") => "Encerrar o Matra Notch",
        ...
        ("zh", "quit_app") => "退出 Matra Notch",
        ("zh-Hant", "quit_app") => "結束 Matra Notch",
        ("ja", "quit_app") => "Matra Notch を終了",
        ("ko", "quit_app") => "Matra Notch 종료",
        ("ru", "quit_app") => "Выйти из Matra Notch",
        ("uk", "quit_app") => "Вийти з Matra Notch",
        (_, "quit_app") => "Quit Matra Notch",
        ("zh", "settings") => "设置…",
        ("zh-Hant", "settings") => "設定…",
        ("ja", "settings") => "設定…",
        ("ko", "settings") => "설정…",
...
mod tests {
    ...
    const BRAZILIAN_PORTUGUESE_KEYS: &[(&str, &str)] = &[
        ...
        ("quit_app", "Encerrar o Matra Notch"),
